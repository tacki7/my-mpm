...
// standard preset on that coarse mesh (docs/validation.md: 4.30 kN/mm, 0.7555 mm).
...
try {
  ...
  between(mean(steady.map((d) => d.rollForce)) * 1e-6, 3.5, 5.0, 'steady roll force [kN/mm] (6 cells: 4.30)');
