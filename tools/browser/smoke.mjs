...
// standard preset on that coarse mesh (docs/validation.md「標準条件」: 3.24 kN/mm, 0.7519 mm).
...
try {
  ...
  between(mean(steady.map((d) => d.rollForce)) * 1e-6, 2.8, 4.0, 'steady roll force [kN/mm] (6 cells: 3.24; 4.31 with the contact band of before)');
