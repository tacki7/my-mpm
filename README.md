...
![前方張力が過大: 頭端の近くで板がくびれ、板厚を貫いて割れたところ（損傷 D）](docs/img/front-tension-damage.png)

条件 `?preset=front-tension&field=damage&autorun=1`。最初の亀裂から 150 ステップで止め、俯瞰の帯の朱の印をクリックして亀裂へ移り、ホイールで拡大した。
出口の先で板が伸びてくびれ、頭端から約 1 mm のところで上下の面から割れて板厚を貫く（亀裂 1〜4 が 19.72〜19.75 ms にほぼ同時）。藍墨が亀裂になった点。
